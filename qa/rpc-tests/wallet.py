...
#   c) node1 mines 32 blocks, so now node 0 has 60001slc, node 1 has 4250slc, node2 has none.
#   d) node0 sends 601 slc to node2, in two transactions (301 slc, then 300 slc).
