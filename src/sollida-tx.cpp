...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("sollida Core sollida-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  sollida-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded sollida transaction") + "\n" +
                               "  sollida-tx [options] -create [commands]   " + _("Create hex-encoded sollida transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded sollida transaction
