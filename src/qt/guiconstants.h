...
/* sollida GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "sollida"
#define QAPP_ORG_DOMAIN "sollida.org"
#define QAPP_APP_NAME_DEFAULT "sollida-Qt"
#define QAPP_APP_NAME_TESTNET "sollida-Qt-testnet"
