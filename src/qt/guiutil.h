...
/** Utility functions used by the sollida Qt UI.
 */
namespace GUIUtil
{
...
// Render sollida addresses in monospace font
...
// Parse "sollida:" URI into recipient object, return true on successful parsing
