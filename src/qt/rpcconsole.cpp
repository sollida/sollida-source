                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzSLCPathCustom = GetArg("-zslcbackuppath", "");
    ...
    if(!strzSLCPathCustom.empty()) {
        ui->wallet_customzslcbackuppath->setText(QString::fromStdString(strzSLCPathCustom));
        ui->wallet_customzslcbackuppath_label->setVisible(true);
        ui->wallet_customzslcbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzSLCPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the sollida RPC console.") + "<br>" +
