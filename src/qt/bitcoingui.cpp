                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("sollida Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a sollida address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and sollida: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zSLC"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About sollida Core"), this);
    aboutAction->setStatusTip(tr("Show information about sollida Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for sollida"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your sollida addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified sollida addresses"));
    ...
    openAction->setStatusTip(tr("Open a sollida: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the sollida Core help message to get a list with possible sollida command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("sollida Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to sollida network", "", count));
}
...
{
    QString strTitle = tr("sollida Core"); // default title
