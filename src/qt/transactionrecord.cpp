...
QList<TransactionRecord> TransactionRecord::decomposeTransaction(const CWallet* wallet, const CWalletTx& wtx)
{
    ...
    if (wtx.IsCoinStake()) {
        ...
        if (wtx.IsZerocoinSpend() && (fZSpendFromMe || wallet->zslcTracker->HasMintTx(hash))) {
            //zSLC stake reward
            sub.involvesWatchAddress = false;
            sub.type = TransactionRecord::StakeZSLC;
...
bool IsZSLCType(TransactionRecord::Type type)
{
    switch (type) {
        case TransactionRecord::StakeZSLC:
...
void TransactionRecord::updateStatus(const CWalletTx& wtx)
{
    ...
    else if (type == TransactionRecord::Generated || type == TransactionRecord::StakeMint || type == TransactionRecord::StakeZSLC || type == TransactionRecord::MNReward) {
