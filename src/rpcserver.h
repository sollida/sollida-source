...
/**
 * sollida RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzslcseed(const UniValue& params, bool fHelp);
extern UniValue getzslcseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzslc(const UniValue& params, bool fHelp);
extern UniValue dzslcstate(const UniValue& params, bool fHelp);
