...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "sollida server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* sollida features */
        {"sollida", "masternode", &masternode, true, true, false},
        {"sollida", "listmasternodes", &listmasternodes, true, true, false},
        {"sollida", "getmasternodecount", &getmasternodecount, true, true, false},
        {"sollida", "masternodeconnect", &masternodeconnect, true, true, false},
        {"sollida", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"sollida", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"sollida", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"sollida", "masternodecurrent", &masternodecurrent, true, true, false},
        {"sollida", "masternodedebug", &masternodedebug, true, true, false},
        {"sollida", "startmasternode", &startmasternode, true, true, false},
        {"sollida", "createmasternodekey", &createmasternodekey, true, true, false},
        {"sollida", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"sollida", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"sollida", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"sollida", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"sollida", "getmasternodescores", &getmasternodescores, true, true, false},
        {"sollida", "mnbudget", &mnbudget, true, true, false},
        {"sollida", "preparebudget", &preparebudget, true, true, false},
        {"sollida", "submitbudget", &submitbudget, true, true, false},
        {"sollida", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"sollida", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"sollida", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"sollida", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"sollida", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"sollida", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"sollida", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"sollida", "checkbudgets", &checkbudgets, true, true, false},
        {"sollida", "mnsync", &mnsync, true, true, false},
        {"sollida", "spork", &spork, true, true, false},
        {"sollida", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzslcseed", &getzslcseed, false, false, true},
        {"zerocoin", "setzslcseed", &setzslcseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzslc", &searchdzslc, false, false, true},
        {"zerocoin", "dzslcstate", &dzslcstate, false, false, true}
...
{
    return "> sollida-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:8745/\n";
}
