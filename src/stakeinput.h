...
#ifndef sollida_STAKEINPUT_H
#define sollida_STAKEINPUT_H
...
public:
    ...
    virtual bool IsZSLC() = 0;
    virtual CDataStream GetUniqueness() = 0;
};


// zSLCStake can take two forms
// 1) the stake candidate, which is a zcmint that is attempted to be staked
// 2) a staked zslc, which is a zcspend that has successfully staked
...
public:
    ...
    bool IsZSLC() override { return true; }
...
public:
    ...
    bool CreateTxIn(CWallet* pwallet, CTxIn& txIn, uint256 hashTxOut = 0) override;
    bool CreateTxOuts(CWallet* pwallet, vector<CTxOut>& vout, CAmount nTotal) override;
    bool IsZSLC() override { return false; }
};


#endif //sollida_STAKEINPUT_H
