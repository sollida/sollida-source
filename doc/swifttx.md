...
This mechanism has been integrated into Bitcore-Node-sollida which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/sollida-Project/insight-api-sollida#web-socket-api](https://github.com/sollida-Project/insight-api-sollida#web-socket-api) 
* API: [https://github.com/sollida-Project/insight-api-sollida#swifttx-transactions](https://github.com/sollida-Project/insight-api-sollida#swifttx-transactions) 
...
By default, the sollida Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the sollida Core daemon:
