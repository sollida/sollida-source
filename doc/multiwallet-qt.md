...
In order to support loading of multiple wallets in sollida-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is sollida.cpp.
...
Changes to sollida.cpp
----------------------
sollida.cpp is the entry point into sollida-qt, and as such, will require some minor modifications to provide hooks for
