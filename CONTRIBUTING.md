Contributing to sollida Core
============================

The sollida Core project operates an open contributor model where anyone is
...
The following applies to code changes to the sollida Core project, and is not to be
confused with overall sollida Network Protocol consensus changes.

Whether a pull request is merged into sollida Core rests with the project merge
...
Patches that change sollida consensus rules are considerably more involved than
...
Where a patch set proposes to change the sollida consensus, it must have been
...
The project leader is the release manager for each sollida Core release.
