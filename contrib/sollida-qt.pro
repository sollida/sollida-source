...
RESOURCES += src/qt/sollida.qrc src/qt/sollida_locale.qrc

TRANSLATIONS += src/qt/locale/sollida_bg.ts \
                src/qt/locale/sollida_de.ts \
                src/qt/locale/sollida_en.ts \
                src/qt/locale/sollida_es.ts \
                src/qt/locale/sollida_fi.ts \
                src/qt/locale/sollida_fr.ts \
                src/qt/locale/sollida_it.ts \
                src/qt/locale/sollida_ja.ts \
                src/qt/locale/sollida_pl.ts \
                src/qt/locale/sollida_pt.ts \
                src/qt/locale/sollida_ru.ts \
                src/qt/locale/sollida_sk.ts \
                src/qt/locale/sollida_sv.ts \
                src/qt/locale/sollida_vi.ts \
                src/qt/locale/sollida_zh_CN.ts \
                src/qt/locale/sollida_zh_TW.ts
